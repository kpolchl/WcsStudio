defmodule WcsStudio.Accounts.User do
  ...
  def get_instructors do
    from(u in WcsStudio.Accounts.User, where: u.role == "instructor")
    |> WcsStudio.Repo.all()
  end
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, WcsStudio.Repo)
  ...
  """
  def valid_password?(%WcsStudio.Accounts.User{hashed_password: hashed_password}, password)
