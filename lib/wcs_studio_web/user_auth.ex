defmodule WcsStudioWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      WcsStudioWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule WcsStudioWeb.PageLive do
        use WcsStudioWeb, :live_view

        on_mount {WcsStudioWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{WcsStudioWeb.UserAuth, :ensure_authenticated}] do
